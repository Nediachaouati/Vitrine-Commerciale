    ...
    return (
        <div className="flex h-[calc(100vh-60px)] overflow-hidden">
            ...
            <div className="w-[40%] flex flex-col border-r border-white-light dark:border-[#1b2e4b]">
                <ChatPanel collab={collab} portfolios={portfolios} selectedPortfolioId={selectedPortfolioId} />
            </div>

            {/* Panneau droite : Sélecteur + détail */}
            <div className="w-[60%] flex flex-col overflow-y-auto">
                <PortfolioSelector collab={collab} portfolios={portfolios} selectedPortfolioId={selectedPortfolioId} onSelect={(id) => dispatch(SelectPortfolio(id))} />
                ...
                {selectedPortfolio ? (
                    ...
                    <div className="flex flex-col items-center justify-center flex-1 text-center px-8 py-16">
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="currentColor" className="mb-4">
                            <path d="M19 2h-4.18C14.4.84 13.3 0 12 0c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm7 18H5V4h2v3h10V4h2v16z" />
                        </svg>
                        <p className="text-sm text-gray-400">{portfolios.length === 0 ? 'Aucun portfolio. Crée-en un avec le bouton ci-dessus.' : 'Sélectionne un portfolio pour voir son contenu.'}</p>
                    </div>
                )}
            </div>
        </div>
